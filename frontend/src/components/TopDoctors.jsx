...
const TopDoctors = () => {
    ...
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
        <h1 className='text-3xl md:font-medium'>Top Doctors to Book</h1>
        <p className='sm:w-1/3 text-center text-sm'>Simply browse through our extensive list of doctors.</p>
        <div className='w-full grid grid-cols-[var(--grid-cols-auto)] gap-4 pt-5 gap-y-6 px-3 sm:px-0 justify-center'>
