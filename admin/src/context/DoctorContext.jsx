...
const DoctorContextProvider = (props) => {
    ...
    const value = {
        dToken, setDToken, backendURL, appointments, getAppointments, setAppointments, completeAppointment, cancelAppointment, dashData, setDashData, getDashData, profileData, setProfileData, getProfileData
    }
